...
seq.argument('<project>', 'yingting project path')
...
test.argument('<project>', 'yingting project path')
...
build.argument('<project>', 'yingting project path')
