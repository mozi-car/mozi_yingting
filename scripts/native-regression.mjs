...
if (kvaser.canOPEN_CAN_FD() !== 0x0400) throw new Error('kvaser: CAN-FD open flag contract mismatch')
const kvaserErrorText = Buffer.alloc(64)
expectThrow('kvaser.canGetErrorText without DLL', () => kvaser.canGetErrorText(-2, kvaserErrorText))
